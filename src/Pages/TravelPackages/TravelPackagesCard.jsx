  ...
  return (
   <Link to="package">
    <div className='border-0 shadow  mb-3 p-2 rounded cursor-pointer'>
     ...
     <img className='w-full h-auto max-h-full  object-cover object-center   transform scale-100 group-hover:scale-105 transition-transform duration-300' src={image} alt="" />
    ...
    <h3 className='text-[26px]  text-[#3b3a3a] pb-3 font-semibold'>{name}</h3>
