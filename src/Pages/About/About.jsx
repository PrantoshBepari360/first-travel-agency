...
const About = () => {
  ...
  return (
    <>
      ...
      <div className="w-full  flex justify-between border-t-2 mb-20 ">
        ...
        <div className="flex justify-between  mx-auto w-[78rem] mt-40 h-full ">
          <div className="w-[50rem] ">
            ...
            <div className="relative flex">
              <img src={leftUp} className=" mt-[199px] rotate-[-10deg] mt-[200px] rounded-md border-8" alt="tour" />
          ...
          <div className=" w-[40rem] h-[40rem]">
            ...
            <button className="border rounded bg-orange-500 border-orange-500 p-4 mt-4 text-white hover:bg-white hover:text-orange-500 ">Read More</button>

            {/* border bg-orange-500  p-4 mt-10  hover:bg-white border-orange-500 text-orange-500 */}
      ...
      <section className="bg-stone-200 mb-20 ">
            ...
            <div className=" w-[33rem] h-[40rem] ">
              ...
              <div className="">
                <p className=" w-full  mt-10 mb-10 leading-7">
                  {/* text-lg text-justify */}
                  At our travel website, our speciality lies in curating unforgettable experiences that cater to the unique preferences of each traveler. From family vacations to solo adventures, romantic getaways to group escapades, we take pride in offering a diverse range of handpicked destinations and carefully crafted itineraries.
                </p>
                <p className="mb-10 leading-7">Our team of travel experts is dedicated to staying ahead of the curve, ensuring that we bring you the latest travel trends and hidden gems to explore. Whether it's seeking out off-the-beaten-path activities or securing exclusive deals with our trusted partners, our commitment to excellence ensures that every trip planned through our platform is a journey of a lifetime.</p>
                <p className="leading-7">Our 24/7 customer service team is always at your disposal, ready to address any queries or assist with last-minute changes.</p>
              </div>
          ...
          <div className=" w-[40rem] h-[40rem]">
            <div className="flex mb-16 leading-7">
              <div className=" items-center">
                ...
                <p>Experience our innovative tour plans designed to take you off the beaten path and uncover hidden gems.</p>
              </div>
              <div className=" items-center ml-5">
                ...
                <p>Embark on your journey with confidence, guided by our expert travel guides who share their local expertise and insider knowledge.</p>
              </div>
            ...
            <div className="flex gap-6 mt-6">
              <div className=" items-center leading-7">
                ...
                <p>Travel stress-free with our flexible payment policy that accommodates your needs and preferences.</p>
              </div>
              <div className=" items-center">
                ...
                <p>Rest assured that your travel experience is in capable hands with our high-quality management and attention to every detail.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="grid bg-stone-200 mb-20">
