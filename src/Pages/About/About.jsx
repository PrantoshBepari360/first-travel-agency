  ...
  return (
    <>
      <div className="parallax-container relative h-screen overflow-hidden bg-stone-300">
        <div className="parallax-image absolute top-0 left-0 w-full h-[600px] bg-cover bg-center z-0 bgImg bg-fixed relative">
        ...
        >
          {popularTour.map((destination) => (
            <SwiperSlide key={destination.id}>
              <div className="overflow-hidden rounded relative group cursor-pointer rounded-xl">
                <img
