      ...
      <section className="bg-stone-200 ">
        <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center justify-center gap-32 max-w-screen-xl mx-auto p-8 ">
          <div>
            <Heading
              heading3="About Us"
              para2=" This is Photoshop’s version of Lorem Ipsum. Proin gravida nibh vel
        ...
        <div className="flex justify-between  mx-auto w-[78rem] mt-10 mb-20 h-full ">
          <div className="w-[50rem] ">
            <div className=" w-[33rem] h-[40rem] ">
              <Heading
                heading6=" Our Speciality"
                heading2=" Your Trusted Travel Partner"
              />

              <div className="">
                <Heading
                  para2="At our travel website, our speciality lies in curating
