...
const TourBooking = () => {
  ...
  const handleChange = (e) => {
    ...
    setFormValue((prev) => ({
      ...
      ...(prev.destination ? {} : { destination: details.name }),
    }));
          ...
          <div className="p-6 bg-slate-100 flex flex-col md:flex-row justify-between flex-wrap gap-2 shadow rounded">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="checkIn"
                name="checkIn"
                className={`w-full px-3 py-3 border rounded focus:outline-none ${
                  focus.checkIn
                    ? "border-blue-500"
                    : errors.checkIn && !formValue.checkIn
                    ? "border-red-500"
                    : "border-gray-300"
                }`}
                required
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-3 py-3 border rounded focus:outline-none ${
                  focus.checkOut
                    ? "border-blue-500"
                    : errors.checkOut && !formValue.checkOut
                    ? "border-red-500"
                    : "border-gray-300"
                }`}
                required
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-3 py-3 border rounded focus:outline-none ${
                  focus.guests
                    ? "border-blue-500"
                    : errors.guests && !formValue.guests
                    ? "border-red-500"
                    : "border-gray-300"
                }`}
                required
          ...
          <div className="flex flex-col md:flex-row pt-6 items-center justify-between gap-4">
            <div className="mb-1  lg:w-1/2 w-full">
              ...
              <input
                ...
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.firstName ? "border-blue-500" : ""
                }${
                  errors.firstName && !focus.firstName ? " border-red-500" : ""
                }`}
                required
            ...
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <input
                ...
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.lastName ? "border-blue-500" : ""
                }${
                  errors.lastName && !focus.lastName ? " border-red-500" : ""
                }`}
                required
          ...
          <div className="flex flex-col md:flex-row  items-center justify-between gap-4">
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <input
                ...
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.email ? "border-blue-500" : ""
                }${errors.email && !focus.email ? " border-red-500" : ""}`}
                required
            ...
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <input
                ...
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.phone ? "border-blue-500" : ""
                }${errors.phone && !focus.phone ? " border-red-500" : ""}`}
                required
          ...
          <div className="flex flex-col md:flex-row  items-center justify-between gap-4">
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <select
                ...
                name="country"
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.country ? "border-blue-500" : ""
                }${errors.country && !focus.country ? " border-red-500" : ""}`}
            ...
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <select
                ...
                name="district"
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.district ? "border-blue-500" : ""
                }${
                  errors.district && !focus.district ? " border-red-500" : ""
                }`}
          ...
          <div className="flex flex-col md:flex-row  items-center justify-between gap-4">
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <input
                ...
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.town ? "border-blue-500" : ""
                }${errors.town && !focus.town ? " border-red-500" : ""}`}
                required
            ...
            <div className="mb-1 lg:w-1/2 w-full">
              ...
              <input
                ...
                className={`w-full border-2 rounded py-3 px-3 focus:outline-none ${
                  focus.address ? "border-blue-500" : ""
                }${
                  errors.address && !focus.address ? " border-red-500" : ""
                }`}
                required
